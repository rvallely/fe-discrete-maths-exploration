    ...
    case SortingAlgorithmType.BUBBLE_SORT.name:
      return (
        <div>
          <h4>
            Start: [
            {String(returnedApiData.unsortedList)}
            ]
          </h4>
          ...
          <h4>
            End: [
            {String(returnedApiData.sortedList)}
            ]
          </h4>
        </div>
      );
            ...
            <tbody>
              {returnedApiData.iterations.map((step, index) => (
                <tr key={uuidv4()}>
                  ...
                  <td>
                    [
                    {String(step.numberListAfterRemovingValueBeingInserted)}
                    ]
                  </td>
                  <td>
