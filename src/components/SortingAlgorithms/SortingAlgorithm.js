    ...
    return (
        <div>
            <section id="number-list-sorting-form">
                ...
                <form onSubmit={handleSubmit} id="list-sorter" className="row justify-content-center my-3" style={{ border: 'solid', borderColor: 'green' }}>
                      <div className="col-lg-6" style={{ border: 'solid', borderColor: 'purple' }}>
                          ...
                          <div className="mb-4 input-group">
                              ...
                              <span className="input-group-text">
                                    <i title="Copy" className="bi bi-back" onClick={() => navigator.clipboard.writeText(unsortedNumberList)} style={{ cursor: 'pointer' }} />
                                </span>
                            </div>
                          ...
                          <div className="mb-4 input-group">
                              <span className="input-group-text">🙂</span>
                              <input disabled type="text" className="form-control" id="end-value" value={returnedApiData.sortedList} />
                              <span className="input-group-text">
                                    <i title="Copy" className="bi bi-back" onClick={() => navigator.clipboard.writeText(returnedApiData.sortedList)} style={{ cursor: 'pointer' }} />
                                </span>
                            </div>
                          ...
                          <div className="mb-4 input-group">
                              ...
                              <span className="input-group-text">
                                    <i title="Copy" className="bi bi-back" onClick={() => navigator.clipboard.writeText(returnedApiData.inputSize)} style={{ cursor: 'pointer' }} />
                                </span>
                            </div>
                          ...
                          <div className="mb-4 input-group">
                              ...
                              <span className="input-group-text">
                                    <i title="Copy" className="bi bi-back" onClick={() => navigator.clipboard.writeText(returnedApiData.executionTimeMs)} style={{ cursor: 'pointer' }} />
                                </span>
                            </div>
                        </div>
