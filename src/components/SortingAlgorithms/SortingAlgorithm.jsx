...
import lightBgrdDarkDetailDownArrows from '../../assets/arrows/arrowsDownLightBlueDark.mp4';
import lightBgrdDarkDetailUpArrows from '../../assets/arrows/arrowsUpLightBlueDark.mp4';
                ...
                <div className="row">
                    ...
                    <div className="col-5">
                        <form
                            ...
                            id="list-sorter"
                            className="row justify-content-center my-3 rounded-box rounded-box-shadow dark-font"
                        >
                  ...
                  Please input a list of numbers delineated by a comma and a space:
                                ...
                                <div className="mt-4 mb-0 text-center">
                                    <button
                                        type="submit"
                                        className="btn btn-lg text-center mb-2 button blue-button light-font"
                                    >
                                      Sort
                                    </button>
                                </div>
