...
function ColourRepresentation () {
    ...
    return <div className='real-world-use-container' style={{ marginLeft: '2%', marginRight: '2%' }}>
        ...
        <p>
            Hexadecimal (base 16) is used for colour representation in computer programming. Hexadecimal is
            more compatible with this application than binary for example, because it provides a more compact
            representation, with each hexadecimal digit representing four binary digits - &apos;1101&apos; in binary is
            &apos;D&apos; in hexadecimal.
        </p>
        <p>
            As you can see below, it&apos;s a much more human readable system than binary and therefore is less
            error prone.
        </p>
        <div className="row align-contents-center number-base-section-margins real-world-use-example rounded-box">
            ...
            >
                ...
                Click anywhere on the code block below to toggle between showing the usual hexadecimal colour values
                and a hypothetical binary representation:
                </p>
                <p
                ...
                >
                    ...
                    <br></br>
                    <span
                        style={{ color: '#92CDEC', marginLeft: '4%' }}
                    >
                        width:
                    </span><span style={{ color: '#A1C7AB' }}> 500px</span><span style={{ color: '#D0CBC5' }}>;</span>
                    <br></br>
                    <span
                        style={{ color: '#92CDEC', marginLeft: '4%' }}
                    >
                        height:</span><span style={{ color: '#A1C7AB' }}> 500px</span><span
                        style={{ color: '#D0CBC5' }}>;</span>
                    <br></br>
                    <span
                        style={{ color: '#92CDEC', marginLeft: '4%' }}
                    >
                        border-radius:</span><span
                        style={{ color: '#A1C7AB' }}> 1000px</span><span style={{ color: '#D0CBC5' }}>;</span>
                    <br></br>
                    <span
                        style={{ color: '#92CDEC', marginLeft: '4%' }}
                    >
                        ...
                        style={{ color: '#DCDC9E' }}
                    > conic-gradient</span><span style={{ color: '#CA72D1' }}>(</span>
                    <br></br>
                    {colourSegmentValues.values.map(({ colour, degrees }) => {
                        return <div key={colour}>
                            <span
                                style={{ color: '#CD8757', marginLeft: '8%' }}
                            >{colour}</span><span
                                style={{ color: '#A1C7AB' }}> {degrees}</span><span
                                style={{ color: '#D0CBC5' }}>,</span>
                        </div>;
                    })}
                    <span
                        style={{ color: '#CA72D1', marginLeft: '4%' }}
                    >)</span><span style={{ color: '#D0CBC5' }}>;</span>
                    <br></br>
                    <span style={{ color: '#FED841' }}>&#125;</span>
                </p>
            </div>
